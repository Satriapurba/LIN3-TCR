...
ki = LINETCR.LINE()
ki.login(token="EmYzys2n7ihwqEEYp3Ee.CjIvA0vExq5yWKKZhGRiBG.DLrUs+9HrAUircbagmJ2EZ3dyo6vZ9Ndy8E03EbPi/s=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Em9y81gEiBINhBBLhksa.zzZqYn4sZBzbe1l8ZQVdAG.ckIOruUiOE064X/h9fqJ6qfxpI7O3bhFoTV0tx82YfY=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmSY0cRznt2UKf8Myvk9.m7rP1Ip4L/1WLzqQaK3EEq.25QzVsN0SBQFqSqjvpwgQTSlCAJnVrf+JtKTkPOtyVw=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EmhqGJKQdt5xjMb7tFP9.AkcyHBAp92K0m4eR75yaEq.TEOd09A0Rohd83FW4B39dd+xjEuYhXtncCKz3cJ+HR4=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EmUDRIe1Zr3EkNpweA03.8LQyGxdtNSFomT9kPZCoGW.59yyg/joVdYcbpDdn35/a7yYE4Rvmy2QAYov+L5S5tY=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EmYgHKwIGj5dhR1lK7ca.TSp1Ca4pGUmDnNd3+qa8QG.jmoV4Wgnkq/uHlVwzIgS53gFeYr+yh5JoyvhHNZ0AZ8=")
ki6.loginResult()
print "login success"
reload(sys)
...
admsa =["uc72e39d8c26cb3aacad5201e6f2c348c","u88f6c775458685ca77552eef4dade464"]
admin =["uc72e39d8c26cb3aacad5201e6f2c348c","u88f6c775458685ca77552eef4dade464"]
...
#-----------------------------------------------
                ...
                if msg.from_ in admin                  print "[Command]Admin add executing"
...
#--------------------------------------------------------
                ...
                if wait["atjointicket"] == True: md+="􀜁􀇔􏿿Ticket:on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿Ticket:off 􀜁􀄰􏿿\n"
                ...
                ki6.sendText(msg.to,h)
                    ...
                    h = ""
                    for i in gid:
                        h += "👉 %s  \n" % (ki2.getGroup(i).name + " | Members : " + str(len (ki2.getGroup(i).members)))
                    ki2.sendText(msg.to, "☆「Group List」☆\n"+ h +"Total Group : " +str(len(gid)))
            elif msg.text in ["Sf3 groups"]:
                    gid = ki3.getGroupIdsJoined()
                    h = ""
                    for i in gid:
                        h += "👉 %s  \n" % (ki3.getGroup(i).name + " | Members : " + str(len (ki3.getGroup(i).members)))
                    ki3.sendText(msg.to, "☆「Group List」☆\n"+ h +"Total Group : " +str(len(gid)))
            elif msg.text in ["Sf4 groups"]:
                    gid = ki4.getGroupIdsJoined()
                    h = ""
                    for i in gid:
                        h += "👉 %s  \n" % (ki4.getGroup(i).name + " | Members : " + str(len (ki4.getGroup(i).members)))
                    ki4.sendText(msg.to, "☆「Group List」☆\n"+ h +"Total Group : " +str(len(gid)))

            elif msg.text in ["Sf5 groups"]:
                    gid = ki5.getGroupIdsJoined()
                    h = ""
                    for i in gid:
                        h += "👉 %s  \n" % (ki5.getGroup(i).name + " | Members : " + str(len (ki5.getGroup(i).members)))
                    ki5.sendText(msg.to, "☆「Group List」☆\n"+ h +"Total Group : " +str(len(gid)))
            elif msg.text in ["Sf6 groups"]:
                    gid = ki6.getGroupIdsJoined()
                    h = ""
                    for i in gid:
                        h += "👉 %s  \n" % (ki6.getGroup(i).name + " | Members : " + str(len (ki6.getGroup(i).members)))
                    ki6.sendText(msg.to, "☆「Group List」☆\n"+ h +"Total Group : " +str(len(gid)))
